...
from .models import N8nConfig, EnvironmentConfig, StackConfig
    ...
    def _apply_stack_type(
        ...
        if stack_config.settings:
            ...
            if 'components' in stack_config.settings:
                ...
                modified_config.settings.features['components'] = stack_config.settings['components']
        ...
        example_config = {
            ...
            "stacks": {
                ...
                "standard": {
                    ...
                    "components": ["fargate", "efs", "api_gateway", "cloudfront", "monitoring"],
