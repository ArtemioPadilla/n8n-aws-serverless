...
class AccessStack(N8nBaseStack):
    ...
    def _create_api_gateway(self) -> apigatewayv2.HttpApi:
        ...
        api = apigatewayv2.HttpApi(
            ...
            ) if self.access_config else None,
        )
    ...
    def _create_cloudfront_distribution(self) -> cloudfront.Distribution:
        ...
        distribution = cloudfront.Distribution(
            ...
            domain_names=[self.access_config.domain_name] if self.access_config and self.access_config.domain_name else None,
            certificate=certificate,
            minimum_protocol_version=cloudfront.SecurityPolicyProtocol.TLS_V1_2_2021,
            price_class=cloudfront.PriceClass.PRICE_CLASS_100 if self.is_development() else cloudfront.PriceClass.PRICE_CLASS_ALL,
            enabled=True,
