...
class MonitoringStack(N8nBaseStack):
    ...
    def _create_custom_n8n_metrics(self) -> None:
        ...
        custom_namespace = self.monitoring_config.custom_metrics_namespace if self.monitoring_config else "N8n/Serverless"
    ...
    def _create_workflow_execution_metrics(self, namespace: str) -> None:
        ...
        logs.MetricFilter(
            ...
            metric_value="1",
            filter_pattern=logs.FilterPattern.literal('[timestamp, request_id, level="info", message="Workflow execution finished successfully*"]'),
            default_value=0,
        )
        ...
        logs.MetricFilter(
            ...
            metric_namespace=namespace,
            metric_value="1",
            filter_pattern=logs.FilterPattern.literal('[timestamp, request_id, level="error", message="Workflow execution failed*"]'),
            default_value=0,
        )
        ...
        logs.MetricFilter(
            ...
            filter_pattern=logs.FilterPattern.literal('[timestamp, request_id, level="info", message="Workflow execution finished*", duration]'),
            default_value=0,
        )
    ...
    def _create_webhook_metrics(self, namespace: str) -> None:
        ...
        logs.MetricFilter(
            ...
            metric_namespace=namespace,
            metric_value="1",
            filter_pattern=logs.FilterPattern.literal('[timestamp, request_id, level="info", message="Webhook received*"]'),
            default_value=0,
        )
        ...
        logs.MetricFilter(
            ...
            filter_pattern=logs.FilterPattern.literal('[timestamp, request_id, level="info", message="Webhook processed*", response_time]'),
            default_value=0,
    ...
    def _create_error_metrics(self, namespace: str) -> None:
        ...
        logs.MetricFilter(
            ...
            metric_namespace=namespace,
            metric_value="1",
            filter_pattern=logs.FilterPattern.literal('[timestamp, request_id, level="error", message="Database connection failed*"]'),
            default_value=0,
        )
    ...
    def _create_performance_metrics(self, namespace: str) -> None:
        ...
        logs.MetricFilter(
            ...
            filter_pattern=logs.FilterPattern.literal('[timestamp, request_id, level="info", message="Node executed*", node_type, execution_time]'),
            default_value=0,
            unit=cloudwatch.Unit.MILLISECONDS,
        )
        ...
        logs.MetricFilter(
            ...
            filter_pattern=logs.FilterPattern.literal('[timestamp, request_id, level="info", message="Queue status*", queue_size]'),
            default_value=0,
        )
