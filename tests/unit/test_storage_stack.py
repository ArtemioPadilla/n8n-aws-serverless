...
class TestStorageStack:
    ...
    def test_efs_file_system_creation(self, app, test_config, network_stack_mock):
        ...
        template.has_resource_properties("AWS::EFS::FileSystem", {
            ...
            "FileSystemTags": Match.array_with([
                {"Key": "Name", "Value": Match.string_like_regexp("test-n8n-test-efs-n8n")},
    ...
    def test_efs_access_point_creation(self, app, test_config, network_stack_mock):
        ...
        # Verify access point
        template.has_resource_properties("AWS::EFS::AccessPoint", {
            "RootDirectory": {
                "Path": "/n8n-data",
                "CreationInfo": {
                    "OwnerUid": "1000",
    ...
    def test_cross_region_backup_configuration(self, app, test_config, network_stack_mock):
        ...
        test_config.environments["test"].settings.backup.backup_regions = ["us-west-2", "eu-west-1"]
