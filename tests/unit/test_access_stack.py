...
class TestAccessStack:
    ...
    def test_stack_initialization_basic(self, app, test_config_basic, compute_stack_mock):
    ...
    def test_vpc_link_creation(self, app, test_config_basic, compute_stack_mock):
        ...
        # Verify VPC link
        template.has_resource_properties("AWS::ApiGatewayV2::VpcLink", {
    ...
    def test_waf_web_acl_creation(self, app, test_config_waf, compute_stack_mock):
        ...
        template.has_resource_properties("AWS::WAFv2::IPSet", {
